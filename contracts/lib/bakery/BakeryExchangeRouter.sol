...
contract BakeryExchangeRouter {
    ...
    address private constant _ETH_IDENTIFIER = address(0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE);
    ...
    function _swap(
        ...
        if (tokenIn == _ETH_IDENTIFIER) {
            ...
            require(IWETH(weth).transfer(address(pools[0]), msg.value), "!transfer");
        } else {
    ...
    function _buy(
        ...
        if (tokenIn == _ETH_IDENTIFIER) {
            ...
            require(IWETH(weth).transfer(address(pools[0]), tokensSold), "!transfer");
        } else {
